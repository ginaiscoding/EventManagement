...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func setNotificationCategories() {
        ...
        let confirmAction = UNNotificationAction(identifier: Strings.confirmActionId, title: "✅ Attending")
        
        let laterAction = UNNotificationAction(identifier: Strings.laterActionId, title: "🔄 Will take later")
        
        let category = UNNotificationCategory(identifier: Strings.eventNotificationCategoryId,
